  ...
  <body>
    ...
    <main>
      <div id="box1">
        ...
        <br />
        <br />
        <p style="font-weight: bold; font-size: 20px">이현재</p>
        <br />
      ...
      <div id="box2">
        ...
        <br />
        <p>
          안녕하세요:) 햇수로 10년 동안 프로그래밍을 해 온 이현재입니다.<br />
          플랫폼, 웹서버 그리고 게임 서버 등을 개발했었고 현재는 HJ
          엔터테인먼트에서 일하고 있습니다.<br />
          학부생 시절 우연한 계기로 C언어를 배웠는데 이를 계기로 개발자로 일하고
          있습니다. <br />
          학부생 시절 아무것도 모르는 상황에서 게임을 만드는 과제를 했었는데
          그때의 뿌듯한 추억이 아직도 기억이 납니다.<br />
          그리고 그 경험을 통해 10년 동안 개발을 하고 있는 지금도 어렵고 힘든
          것이 나오면 어떻게든 되겠지라는 호기로운 마음을 가지고 있습니다.<br />
          지금은 저와 같이 어렵게 프로그램을 공부하는 시대는 지났지만, 아직도
          프로그래밍하면 막연히 어렵고 두려운 것으로 생각하시는 분들이 있을 것
          같습니다.<br />
          멘토링을 통해 해결해보세요!
        </p>
        <br /><br />
        ...
        <h2>경력</h2>
        <br />
        <li>(현)HJ 엔터테인먼트 엔지니어</li>
        <li>진학사 catch 직무 멘토링 강의 진행</li>
        <li>한국대학교 멘토링</li>
        ...
        <br />
        <p>
          현역 개발자분이 알려주시는 꿀팁이 많습니다.<br />
          완전 추천합니다. 코딩을 전혀 모르는 문외한도 천천히 따라 하면 실력을
          키울 수 있습니다.<br />
          멘토님께 감사합니다.
        </p>
      </div>
