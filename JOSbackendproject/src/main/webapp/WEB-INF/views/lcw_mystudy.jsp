...
<head>
	...
	<script src="<%=request.getContextPath() %>/resources//js/lcw_card_list_my.js"></script>
...
<body>
	...
	<br>
	<!--    //////////////////////////////////////////////////////////////  -->
	<section class="sub_wrap sub_wrap02">
		<div class="content-container">

			<div class="side_sub_filter">
				<form action="">
					<div class="left-sidebar-top">
						<a href="./lcw_studygroup.html"><img src="./img/lcw_main_menu5.png" class="sidebar-top-study"><span class="study">
							ì¤í°ëëª¨ì§</span>
							</a>
					</div>
					...
					<div>
						<div class="left-sidebar-line1">
							<br>
							<a href="./lcw_mystudy.html"><p class="left-sidebar-mystudy" >ëì ì¤í°ë</p></a>
							<br>
						</div>
					</div>
					<div>
					...
					<div>
						<div class="left-sidebar-line">
							...
							<br>
							<ul>
								<li><input type="checkbox" id="checkfield" value="ëª¨ì§ì¤">êµ­ë´</li><br>
								<li><input type="checkbox" id="checkfield" value="ëª¨ì§ìë£">êµ­ì¸</li><br>
				...
				<div class="sub_con">
					<div class="list_sub_wrap">
						<div class="list_type_title">
							<h1> <span class="type_pick01">ëì </span>&nbsp; ì¤í°ë PICK
								<!-- ( 8 ê±´ ) -->
						...
						<div class="partition">
							<div>
								<h1 class="crack1">|| ì·¨ì ì¤í°ë</h1>
															<h1 class="crack2">|| ìê²©ì¦ ì¤í°ë</h1>
							</div>
								...
								<li class="sub_cnt_list sub_cnt_list01 ">
									<a href="" class="new_out_bg on">
										...
										<div class="pick_con_img"
											style="background-image:url('/images/career_study.jpg')">
										</div>

										<div class="main_cnt_txtbox">
											<dl>
												<dt class="view20Byte"></dt>
												<dd>
													<p class="infor txt01"><span class="red cate_infor"></span></p>
													<p class="infor thin date_infor txt02"></p>
													<p class="infor2 thin txt03"><span class="check_person thin">
															<strong></strong></span><span class="thin add_infor"></span>
													</p>
												</dd>
												<dd>
													<p class="infor3"><strong class="thin"><span
																class="red thin"></span></strong></p>
												</dd>
											</dl>
										</div>
									</a>
